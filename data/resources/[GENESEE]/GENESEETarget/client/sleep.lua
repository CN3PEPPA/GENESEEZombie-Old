CreateThread(function()
    local models = {"prop_skid_tent_03", "prop_rub_matress_01","prop_rub_matress_01","apa_mp_h_bed_double_08","prop_skid_tent_01","bkr_prop_biker_campbed_01"}
    ...
    exports['target']:AddTargetModel(models, { -- Isso define os modelos, pode ser uma string ou uma tabela
        ...
        { -- Esta é a primeira tabela com opções, você pode fazer quantas opções quiser dentro da tabela de opções
            ...
            event = "pz_dormir:fallAsleep", -- Este é o evento que será acionado ao clicar, este pode ser um evento de cliente, evento de servidor ou comando
            icon = 'fa-solid fa-bed', -- Este é o ícone que será exibido ao lado desta opção de gatilho
            label = 'Dormir' -- Este é o rótulo desta opção que você poderá clicar para acionar tudo, isso tem que ser uma string
...
RegisterNetEvent('GENESEETarget:SleepCL')
AddEventHandler('GENESEETarget:SleepCL', function()
