...
local weapon_types = {"WEAPON_DAGGER", "WEAPON_BAT", "WEAPON_BOTTLE", "WEAPON_CROWBAR", "WEAPON_FLASHLIGHT",
                      "WEAPON_GOLFCLUB", "WEAPON_HAMMER", "WEAPON_HATCHET", "WEAPON_KNUCKLE", "WEAPON_KNIFE",
                      "WEAPON_MACHETE", "WEAPON_SWITCHBLADE", "WEAPON_NIGHTSTICK", "WEAPON_WRENCH", "WEAPON_BATTLEAXE",
                      ...
                      "WEAPON_RAYPISTOL", "WEAPON_CERAMICPISTOL", "WEAPON_NAVYREVOLVER", "WEAPON_MICROSMG",
                      ...
                      "WEAPON_HEAVYSNIPER", "WEAPON_HEAVYSNIPER_MK2", "WEAPON_MASKMANRIFLE", "WEAPON_MASKMANRIFLE_MK2",
                      ...
                      "WEAPON_RAYMINIGUN", "WEAPON_GRANADE", "WEAPON_BZGAS", "WEAPON_MOLOTOV", "WEAPON_STICKYBOMB",
                      "WEAPON_PROXMINE", "WEAPON_SNOWBALL", "WEAPON_PIPEBOMB", "WEAPON_BALL", "WEAPON_SMOKEGRENADE",
                      "WEAPON_FLARE", "WEAPON_PETROLCAN", "GADGET_PARACHUTE", "WEAPON_FIREEXTINGUISHER"}
