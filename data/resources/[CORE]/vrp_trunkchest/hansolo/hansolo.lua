...
RegisterNUICallback('requestInventories', function(data, cb)
    local inventory, trunkinventory, weight, maxweight, trunkweight, maxtrunkweight, tSlot, tcSlot =
        vRPNserver.Inventories()
    local imageService = config.imageService
    if inventory then
        cb({
            inventory = inventory,
            trunkinventory = trunkinventory,
            weight = weight,
            maxweight = maxweight,
            trunkweight = trunkweight,
            maxtrunkweight = maxtrunkweight,
            tSlot = tSlot,
            tcSlot = tcSlot,
