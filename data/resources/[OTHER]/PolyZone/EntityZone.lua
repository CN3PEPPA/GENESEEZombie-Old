...
function UpdateOffsets(entity, zone)
    ...
    if zone.debugBlip then
        SetBlipCoords(zone.debugBlip, pos.x, pos.y, 0.0)
    end
end
...
function EntityZone:onEntityDamaged(onDamagedCb)
    ...
    self.damageEventHandlers[#self.damageEventHandlers + 1] =
